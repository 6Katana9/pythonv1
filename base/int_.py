...
num2 = 0.5
# print(type(num2)) # float - выводит тип данных переменной
...
print(round(5.5)) # 6 
print(round(5.4)) # 5
print(round(5.499999)) # 5 - округление идет только по первой цифре после точки

# можно указать кол-во цифр после запятой
# print(round(5.49, 1)) 
